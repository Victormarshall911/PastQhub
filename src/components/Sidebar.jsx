    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto py-3 px-3">
          ...
          <button
            onClick={() => { onHome(); onCloseMobile(); }}
            className={`
              w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-semibold mb-3
          ...
          >
            <div className={`w-6 h-6 rounded-lg flex items-center justify-center ${
              isHome ? 'bg-white/20' : 'bg-surface-100'
            }`}>
              <Home className={`w-3.5 h-3.5 ${isHome ? 'text-white' : 'text-surface-500'}`} />
            </div>
            Dashboard
          </button>
